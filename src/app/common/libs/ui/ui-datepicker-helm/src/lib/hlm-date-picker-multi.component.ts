...
export class HlmDatePickerMultiComponent<T> {
	...
	protected readonly _computedClass = computed(() =>
		hlm(
			'w-full inline-flex items-center gap-2 whitespace-nowrap rounded-md text-sm ring-offset-background transition-colors border border-slate-200 bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 justify-start text-left font-normal',
