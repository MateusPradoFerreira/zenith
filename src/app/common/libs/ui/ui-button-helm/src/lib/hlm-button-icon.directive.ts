...
export class HlmButtonIconDirective implements OnChanges {
  ...
  @Input() size: "default" | "icon" | "icon-lg" = "default";
  ...
  private createIcon() {
    ...
    this.componentRef.setInput("class", (this.size !== "icon" && this.size !== "icon-lg"? (this.hlmBtnIconPosition === "start"? "-ml-2 " : "-mr-2 ") : "") + (this.hlmBtnLoading? "animate-spin" : ""));
