...
export class HlmSelectOptionComponent {
	...
	protected readonly _computedClass = computed(() =>
		hlm(
			'cursor-pointer relative flex w-full select-none items-center rounded-sm py-1.5 pl-8 pr-2 rtl:flex-reverse rtl:pr-8 rtl:pl-2 text-sm outline-none data-[active]:bg-accent data-[active]:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
			this.userClass(),
		),
	);
}
