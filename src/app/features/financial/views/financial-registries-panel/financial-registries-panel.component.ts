...
@Component({
  ...
  imports: [GlobalModule, SecrecyListingComponent, PlanOfAccountListingComponent, CenterOfCostListingComponent, BankAccountListingComponent, ScheduleCategoryListingComponent],
