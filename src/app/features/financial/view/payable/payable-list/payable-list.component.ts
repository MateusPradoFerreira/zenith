...
import { GetAllPayableResponse } from '../../../models/payable.model';
...
export class PayableListComponent extends BaseListComponentDirective<GetAllPayableResponse, GetAllPayableByFilterParams> {
